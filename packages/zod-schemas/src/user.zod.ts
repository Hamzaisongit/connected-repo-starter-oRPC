...
import z from "zod";
import { zString, zTimestamps, zTimezone } from "./zod_utils.js";
...
export const userOptionalZod = z.object({
  image: z.url().nullable(),
	emailNotificationPreference: z.boolean().default(true),
	pushNotificationPreference: z.boolean().default(false),
});
